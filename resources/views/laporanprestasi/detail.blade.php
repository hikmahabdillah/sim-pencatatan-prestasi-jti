...
$(document).ready(function() {
    ...
    $('#export_pdf').click(function() {
        window.location.href = "{{ route('laporan-prestasi.export-mahasiswa', $mahasiswa->id_mahasiswa) }}?format=pdf";
    });
    
    $('#export_excel').click(function() {
        window.location.href = "{{ route('laporan-prestasi.export-mahasiswa', $mahasiswa->id_mahasiswa) }}?format=excel";
    });
    @endif
});
</script>
