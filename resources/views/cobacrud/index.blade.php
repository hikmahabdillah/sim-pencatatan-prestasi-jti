...
@section('content')
    ...
    <div class="container-fluid py-4 h-100 flex-grow-1">
        <button onclick="modalAction('{{ url('cobacrud/create') }}')" class="btn bg-gradient-info mt-1">
            Tambah Data
        </button>
        <div class="card p-3 table-responsive">
            <table id="cobacrud-table" class="table table-hover">
    ...
    @push('js')
        <script>
            ...
            $(document).ready(function() {
                tablecrud = $('#cobacrud-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ url('cobacrud/list') }}",
                        type: "POST",
                    },
                    columns: [{
                            data: 'DT_RowIndex',
