                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_lomba" value="{{ $lomba->nama_lomba }}"
                                class="form-control" required>
                            <div class="text-danger error-text" id="error-nama_lomba"></div>
                        </div>
                        <div class="col-md-6">
                            <label>Penyelenggara</label>
                            <input type="text" name="penyelenggara" value="{{ $lomba->penyelenggara }}"
                                class="form-control" required>
                            ...
                            <select name="id_kategori" class="form-control">
                                @foreach ($id_kategori as $kategori)
                                    <option value="{{ $kategori->id_kategori }}"
                                        {{ $kategori->id_kategori == $lomba->id_kategori ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="biaya_pendaftaran" class="form-control">
                                <option value="1" {{ $lomba->biaya_pendaftaran ? 'selected' : '' }}>Berbayar
                                </option>
                                <option value="0" {{ !$lomba->biaya_pendaftaran ? 'selected' : '' }}>Gratis
                                </option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="berhadiah" class="form-control">
                                ...
                                <option value="0" {{ !$lomba->berhadiah ? 'selected' : '' }}>Tidak Berhadiah
                                </option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="tanggal_mulai" value="{{ $lomba->tanggal_mulai }}"
                                class="form-control">
                            <div class="text-danger error-text" id="error-tanggal_mulai"></div>
                        </div>
                        <div class="col-md-4">
                            <label>Tanggal Selesai</label>
                            <input type="date" name="tanggal_selesai" value="{{ $lomba->tanggal_selesai }}"
                                class="form-control">
