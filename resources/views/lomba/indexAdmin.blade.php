...
<div class="container-fluid py-4 h-100 flex-grow-1">
    ...
    <ul class="nav nav-tabs mb-3" id="verifTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="belum-tab" data-bs-toggle="tab" data-bs-target="#belum" type="button" role="tab" aria-controls="belum" aria-selected="true">Belum Diverifikasi</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="sudah-tab" data-bs-toggle="tab" data-bs-target="#sudah" type="button" role="tab" aria-controls="sudah" aria-selected="false">Terverifikasi</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="rekom-tab" data-bs-toggle="tab" data-bs-target="#rekom" type="button" role="tab" aria-controls="rekom" aria-selected="false">
